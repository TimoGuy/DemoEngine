...
private:
	...
	GLFWwindow* window;
	GLuint program_id, skybox_program_id, model_program_id, shadow_program_id, shadow_skinned_program_id, pbr_program_id, text_program_id, hdri_program_id, irradiance_program_id;
	GLuint vbo, vao, ebo;
