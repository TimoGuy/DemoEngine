...
void* loadResource(const std::string& resourceName)
{
	...
	if (resourceName == "texture;pbrNormal")					return loadTexture2D(resourceName, "res/rusted_iron/rustediron2_normal.png", GL_RGB, GL_RGB, GL_NEAREST, GL_NEAREST, GL_REPEAT, GL_REPEAT);
